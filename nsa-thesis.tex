...
% https://tex.stackexchange.com/questions/3676/too-many-math-alphabets-error | to get amssymb working
\newcommand\hmmax{0}
\newcommand\bmmax{0}
...
\thesistitle{Engineering Multiagent Systems for Ethics Aware and Privacy Respecting Social Computing}
...
\newcommand{\frameworkAinur}{Yumbo\xspace} %https://harrypotter.fandom.com/wiki/Yumbo
\newcommand{\locationapp}{Pichu\xspace} %https://bulbapedia.bulbagarden.net/wiki/Pichu_(Pok%C3%A9mon)
...
% \titlespacing*{\chapter}{0pt}{0.5in-9pt}{22pt}
%\titlespacing*{\chapter}{0pt}{0in-9pt}{22pt}
...
\include{Appendix-Ainur/Appendix-Ainur}
